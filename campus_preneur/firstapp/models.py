...
class UserInfo(models.Model):
    ...
    entered_answers = models.TextField(blank=True)
...
class Question(models.Model):
    ...
    image_clickable = models.BooleanField(default=False)
    file_upload = models.FileField(upload_to='download_files', blank=True)
